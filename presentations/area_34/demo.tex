...
\begin{frame}{Clone Repositories}
  ...
  \begin{itemize}\blue
    ...
    \item[] \href{https://github.com/sofia-taf/2023Area34GlobalEffortFishstatstocks}{2023Area34}\black
...
\begin{frame}[fragile]{R Session}
  \textbf{\darkgreen Three important lines}\\[0.3ex]
  \begin{itemize}
    \item[] \verb|library(TAF)|\\[1ex]
    \item[] \verb|taf.bootstrap()|\\[1ex]
    \item[] \verb|sourceAll()|\\[1ex]
  \end{itemize}
\end{frame}
